    ...
    <section class="section">
      <div class="row">
        <div class="col-lg-12">
          ...
          <div class="card">
            <div class="card-body">
              <h5 class="card-title">Add Cause</h5>

              <!-- General Form Elements -->
              <form method="POST" action="{{ route('store-cause') }}" enctype="multipart/form-data">
                @csrf
                <div class="row mb-3">
                ...
                <div class="row mb-3">
                  ...
                  <div class="col-sm-10">
                    <textarea name="editorContent" id="editorContent" class="form-control" required></textarea>
                  </div>
                </div>
