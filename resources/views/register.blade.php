...
<body>
    ...
    <style>
        body {
            background-image: url('/assets/img/cida_bg.png');
        ...
        <div class="row">
            <div class="col-md-6 offset-md-3">
                <div class="signup-form">
                    <form action="{{ route('auth-register') }}" class="mt-5 border p-4 bg-light shadow" method="POST">
                        @csrf
                        <div class="logo-center" style="display: flex; justify-content: center; align-items: center; height: 100%;">
                            <img src="/assets/img/logo.png" class="logo-image img-fluid" alt="templatemo pod talk" style="height: 150px;width: 150px;">
                        </div>


                        <h4 class="mb-3 mt-2 text-center text-primary">Create new system user</h4>
                    ...
                    <p class="text-center mt-3 text-secondary">If you have account, Please <a
                            href="{{ route('admin-login') }}">Login Now</a></p>
                    <p class="text-center mt-3 text-secondary">Return back to, <a
                            href="{{ route('/') }}">homepage</a></p>
                </div>
            </div>
        </div>
    </div>
